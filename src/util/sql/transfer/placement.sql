...
INSERT
INTO service_need (option_id, placement_id, start_date, end_date, confirmed_by, confirmed_at, shift_care)
SELECT option_id, placement_id, lower(range), upper(range) - interval '1 day', confirmed_by, confirmed_at, shift_care
